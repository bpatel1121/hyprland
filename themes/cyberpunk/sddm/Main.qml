// Cyberpunk · Cybrcolors — SDDM greeter
//
...
Rectangle {
    ...
    color: "#030408"      // no0 — ground, in case the wallpaper fails to load

    // Cybrcolors, same names as waybar/style.css
    readonly property color cPink:  "#F230B2"   // pi0 — frame
    readonly property color cCyan:  "#29BECC"   // cy0 — content
    readonly property color cRed:   "#F24848"   // re0 — failure only
    readonly property color cGray:  "#898D99"   // wh0 — dormant
    readonly property color cFg:    "#C8D0E0"   // text
    readonly property color cInner: "#0A0E1A"   // no2 — raised surfaces
    ...
    Rectangle { anchors.fill: parent; color: "#030408"; opacity: 0.45 }
    ...
    Column {
        ...
        Rectangle {
            ...
            color: root.cInner
            border.width: 1
            border.color: userInput.activeFocus ? root.cPink : "#212638"
            anchors.horizontalCenter: parent.horizontalCenter
            TextInput {
                id: userInput
                anchors.fill: parent
    ...
    ComboBox {
        ...
        background: Rectangle {
            ...
            border.width: 1; border.color: "#212638"
        }
        contentItem: Text {
            leftPadding: 12
